...
public interface GradeService {
     ...
     * @return 学生成绩列表
     */
    PageResult<StudentGradeVO> getStudentGradesList(Long courseId, String semester, Long classId, String studentName, Long teacherId, Integer pageNum, Integer pageSize);
