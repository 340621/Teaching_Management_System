...
public class CourseSelectionServiceImpl extends ServiceImpl<CourseSelectionMapper, CourseSelection> implements CourseSelectionService {
    ...
    @Override
    public com.baomidou.mybatisplus.extension.plugins.pagination.Page<java.util.Map<java.lang.String, java.lang.Object>> getStudentsByCourseId(
            Long courseId, Integer pageNum, Integer pageSize, String name, String studentId) {
        // 创建分页对象
        Page<Map<String, Object>> page = new Page<>(pageNum, pageSize);
        
        // 调用Mapper方法获取数据
        com.baomidou.mybatisplus.core.metadata.IPage<Map<String, Object>> iPage = courseSelectionMapper.selectStudentsByCourseId(page, courseId, name, studentId);
