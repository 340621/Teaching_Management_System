...
public class GradeServiceImpl implements GradeService {
    ...
    public GradeStatisticsVO getGradeStatistics(GradeQueryDTO queryDTO) {
        ...
        // 查询成绩概览
        Map<String, Object> overview = courseSelectionMapper.selectGradeOverviewStats(semester, courseId, classId, teacherId);
        
        // 查询分数分布
        List<Map<String, Object>> scoreDistribution = courseSelectionMapper.selectScoreDistribution(semester, courseId, classId, teacherId);
        
        // 查询班级统计
        List<Map<String, Object>> classStats = courseSelectionMapper.selectClassGradeStats(semester, courseId, classId, teacherId);
    ...
    @Override
    public PageResult<StudentGradeVO> getStudentGradesList(Long courseId, String semester, Long classId, String studentName, Long teacherId, Integer pageNum, Integer pageSize) {
        // 验证参数
