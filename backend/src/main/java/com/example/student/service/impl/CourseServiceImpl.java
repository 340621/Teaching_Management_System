...
public class CourseServiceImpl extends ServiceImpl<CourseMapper, Course> implements CourseService {
    ...
    @Override
    public PageResult<Course> getTeacherCourses(Long teacherId, CourseQueryDTO queryDTO) {
        // 创建分页对象
        Page<Course> page = new Page<>(queryDTO.getPageNum(), queryDTO.getPageSize());
        
        // 调用Mapper查询教师的课程
        IPage<Course> result = courseMapper.selectTeacherCourses(page, teacherId, queryDTO);
