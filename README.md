...
> 2025大三下基于Spring Boot + Spring Security + JWT + MyBatis-Plus的完整教学管理系统
...
## 📋 项目介绍
本项目是一个基于Spring Boot + Spring Security + JWT + MyBatis-Plus的教学管理系统，提供完整的教学管理功能，包括用户认证、学生管理、课程管理、成绩管理等。
...
## 📂 项目结构
```
LLM_Teaching_Management_System
├── config - 配置类
...
## 🚀 运行说明
1. 导入数据库脚本 `sql/LLM_Teaching_Management_System.sql`
2. 修改 `application.yml` 中的数据库和Redis配置
3. 运行 `LLM_Teaching_Management_SystemApplication.java`
...
<p align="center">© 2025 教学管理系统. 保留所有权利.</p>
